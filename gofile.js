...
async function moveAndSortDownloads(downloadFolder) {
  // Utiliser les dossiers de destination de l'application
  const imageFolder = path.join(__dirname, 'data', 'media', 'images');
  const videoFolder = path.join(__dirname, 'data', 'media', 'videos');
